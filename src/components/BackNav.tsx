...
export function BackNav() {
  ...
  return (
    <div
      className="fixed right-[calc(1rem+env(safe-area-inset-right))] bottom-[calc(5.75rem+env(safe-area-inset-bottom))] z-50 flex items-center gap-1.5 rounded-full border border-border bg-card/95 p-1.5 shadow-[var(--shadow-lift)] backdrop-blur-md lg:bottom-[calc(1.5rem+env(safe-area-inset-bottom))]"
      role="navigation"
