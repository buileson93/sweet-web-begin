...
export function QuizFormDialog({ open, onOpenChange, editing }: Props) {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      combo_fx: editing.combo_fx ?? true,
          ...
          <TabsContent value="rules" className="space-y-4">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              {[
                ...
                { key: "combo_fx" as const, title: "Hiệu ứng combo", desc: "Vẫn hiện x2, x3... khi đúng liên tiếp dù không cộng điểm thưởng chuỗi." },
