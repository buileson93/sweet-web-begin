      ...
      <div className="mx-auto flex max-w-5xl items-center px-3 pb-1.5 sm:px-4">
        <span
          className={cn(
            ...
            saveStatus === "offline" || saveStatus === "server-error"
        ...
        >
          ...
          {saveStatus === "saving"
            ? "Đang lưu..."
            : saveStatus === "offline"
              ? "Mất mạng — bài vẫn được giữ trên máy, sẽ tự gửi lại"
              : saveStatus === "server-error"
                ? "Máy chủ chưa nhận được — bài giữ trên máy, báo giám thị nếu kéo dài"
                : lastSavedAt
                  ? "Đã lưu lúc " +
